...
% Application: Korean Exchange Rates
...
%% Step 1: Date Loading
% Data Loading
[Y, ~, ~] = xlsread('ExchangeRate.xlsx', 'ExRate', 'B2:B1501');
...
legend('Exchange rates','Posterior mean'); 
title('Exchange rates and Estimated Volatility');